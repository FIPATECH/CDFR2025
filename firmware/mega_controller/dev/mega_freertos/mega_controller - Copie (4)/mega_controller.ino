 ...
 */
static void sendFrameSerial2(uint16_t function, uint16_t length, const uint8_t *payload)
{
...
void setup() {
    ...
    // Serial3 reste dédié à la réception UART (uart_task)
    Serial3.begin(115200);
    Serial.println("Setup: Serial3 @115200");

    // Serial2 pour l'envoi des points (TX2/RX2)
    Serial2.begin(115200);
    Serial.println("Setup: Serial2 (points) @115200");
    ...
    xTaskCreate(PointsSend_Task,     "POINTS",     256, NULL, 5, NULL);
